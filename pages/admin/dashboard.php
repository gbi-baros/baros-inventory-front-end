            ...
            <div>
              ...
              <div class="flex flex-wrap">
                <div class="w-full lg:w-6/12 xl:w-3/12 px-4">
                  <div
                    class="relative flex flex-col min-w-0 break-words bg-white rounded-lg mb-6 xl:mb-0 shadow-sm"
                  >
                    <div class="flex-auto p-4 border rounded-lg">
                      <div class="flex flex-wrap">
                        ...
                        <div class="relative w-auto pl-4 flex-initial">
                          <div
                            class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 shadow-sm rounded-full bg-red-500"
                          >
                  ...
                  >
                    <div class="flex-auto p-4 border rounded-lg">
                      <div class="flex flex-wrap">
                        ...
                        <div class="relative w-auto pl-4 flex-initial">
                          <div
                            class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 shadow-sm rounded-full bg-orange-500"
                          >
                  ...
                  >
                    <div class="flex-auto p-4 border rounded-lg">
                      <div class="flex flex-wrap">
                        ...
                        <div class="relative w-auto pl-4 flex-initial">
                          <div
                            class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 shadow-sm rounded-full bg-pink-500"
                          >
                  ...
                  >
                    <div class="flex-auto p-4 border rounded-lg">
                      <div class="flex flex-wrap">
                        ...
                        <div class="relative w-auto pl-4 flex-initial">
                          <div
                            class="text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 shadow-sm rounded-full bg-lightBlue-500"
                          >
